...
- [ ] Phase 3: Emails. Builder (port the flexa-mail editor as the starting point), field tokens, template library, Global Styles backed by `Support\Settings`. Ships as milestone M2 (build plan: `docs/M2_PLAN.md`).
