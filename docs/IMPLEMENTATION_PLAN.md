...
- [ ] Phase 1: Forms domain. `Domain/FormRepository` (CPT or custom table decision), Forms list, form builder (needs `@dnd-kit/*`, re-add to package.json), frontend render + submit endpoint.
