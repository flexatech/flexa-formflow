...
if ( ! class_exists( 'Deactivation_Intelligence' ) ) :
	...
	class Deactivation_Intelligence {
		...
		private function reasons() {
			return array(
				array( 'id' => 'no_longer_needed', 'label' => __( 'I no longer need it', 'flexa-formflow' ) ),
				array( 'id' => 'missing_feature', 'label' => __( "It's missing a feature I need", 'flexa-formflow' ), 'followup' => 'feature' ),
				array( 'id' => 'broken', 'label' => __( "Something isn't working", 'flexa-formflow' ), 'followup' => 'broken' ),
				array( 'id' => 'conflict', 'label' => __( 'It conflicts with another plugin/theme', 'flexa-formflow' ), 'followup' => 'conflict' ),
				array( 'id' => 'difficult_to_use', 'label' => __( "It's too difficult to use", 'flexa-formflow' ), 'followup' => 'difficult' ),
				array( 'id' => 'performance', 'label' => __( "It's affecting performance", 'flexa-formflow' ) ),
				array( 'id' => 'alternative', 'label' => __( 'I found a better alternative', 'flexa-formflow' ), 'followup' => 'alternative' ),
				array( 'id' => 'troubleshooting', 'label' => __( "I'm troubleshooting", 'flexa-formflow' ) ),
				array( 'id' => 'other', 'label' => __( 'Other', 'flexa-formflow' ), 'followup' => 'other' ),
			);
		}
		...
		private function strings() {
			return array(
				'title'           => __( 'Before you go…', 'flexa-formflow' ),
				'subtitle'        => __( 'What made you deactivate this plugin?', 'flexa-formflow' ),
				'skip'            => __( 'Skip & deactivate', 'flexa-formflow' ),
				'cancel'          => __( 'Cancel', 'flexa-formflow' ),
				'submit'          => __( 'Deactivate', 'flexa-formflow' ),
				'deactivateAnyway'=> __( 'Deactivate anyway', 'flexa-formflow' ),
				'getHelp'         => __( 'Get help', 'flexa-formflow' ),
				'notify'          => __( 'Notify me if you add it', 'flexa-formflow' ),
				'featureQ'        => __( 'What feature are you looking for?', 'flexa-formflow' ),
				'brokenQ'         => __( 'What went wrong?', 'flexa-formflow' ),
				'conflictQ'       => __( 'Which plugin or theme is it conflicting with?', 'flexa-formflow' ),
				'difficultQ'      => __( 'What was difficult to use?', 'flexa-formflow' ),
				'alternativeQ'    => __( 'What alternative are you using?', 'flexa-formflow' ),
				'otherQ'          => __( 'Anything you would like to share?', 'flexa-formflow' ),
				'optional'        => __( 'Optional', 'flexa-formflow' ),
			);
		}
	}
